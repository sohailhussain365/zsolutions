    ...
    <footer className="bg-[#060B14] border-t border-white/[0.07] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <motion.div
          ...
          variants={stagger}
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 py-14 md:py-16 border-b border-white/[0.07]"
        >
          {/* Brand column */}
          <motion.div variants={fadeUp} className="lg:col-span-1">
            ...
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-blue-500/70 mb-5">
            ...
            <div className="flex items-center gap-2.5">
              <a
                href="https://www.linkedin.com/company/zsolutionz"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="h-9 w-9 rounded-full bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-[0_0_14px_rgba(37,99,235,0.5)] transition-all duration-300"
              >
                <FaLinkedinIn size={13} />
              </a>
              <a
                href="https://www.facebook.com/zsolutionz"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="h-9 w-9 rounded-full bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-[0_0_14px_rgba(37,99,235,0.5)] transition-all duration-300"
          ...
          <motion.div variants={fadeUp}>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-slate-500 hover:text-blue-400 transition-colors text-sm flex items-center gap-2 group">
          ...
          <motion.div variants={fadeUp}>
            ...
            <ul className="space-y-5">
              <li>
                <a href="mailto:info@zsolutionz.com" className="flex items-start gap-3 text-slate-500 hover:text-blue-400 transition-colors group">
              ...
              <li>
                <a href="tel:+12623992770" className="flex items-start gap-3 text-slate-500 hover:text-blue-400 transition-colors group">
                  <div className="h-8 w-8 rounded-lg bg-blue-600/10 flex items-center justify-center text-blue-500 shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 mt-0.5">
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row justify-between items-center gap-4 py-8 text-sm text-slate-600"
        >
